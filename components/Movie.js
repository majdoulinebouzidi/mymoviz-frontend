    ...
    <div className={styles.card}>
      ...
      <div className={styles.textContainer}>
        <div>
          ...
          <p className={styles.description}>{props.overview.length > 250 ? (props.title.length > 32 ? props.overview.slice(0,250-32)+"..." : props.overview.slice(0,250)+"...")  : props.overview}</p>
        </div>
